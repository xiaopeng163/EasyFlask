...
latex_documents = [
    (master_doc, 'cookiecuttermodule_name.tex', '\\{\\{cookiecutter.module\\_name\\}\\} Documentation',
...
man_pages = [
    (master_doc, 'cookiecuttermodule_name', '{{cookiecutter.module_name}} Documentation',
     [author], 1)
]
